    ...
    def tool_schemas(self) -> Dict[str, Dict[str, Any]]:
        ...
        for name in sorted(set(self.capabilities) | set(self.route_schemas)):
            ...
            schemas[name] = {
                ...
                "model_visible": bool(capability.get("model_visible", True)),
                ...
                "preconditions_by_argument": capability.get("preconditions_by_argument") or {},
                "suppress_speech_after_call": bool(capability.get("suppress_speech_after_call", False)),
